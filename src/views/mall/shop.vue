<template>
  <c-layout>
    ...
    <c-main>
      ...
      <c-box-skin>
        ...
        <c-row class="row" pb6>
          <c-col
            ...
            :key="index"
          >
            <c-single-center class="nav__item" pv5>
              <img class="nav__img" :src="item['image']" />
              <span class="nav__span">{{ item["title"] }}</span>
            </c-single-center>
          </c-col>
        </c-row>
      </c-box-skin>
      ...
      <!-- menu -->
      <c-box-center class="menu" bga7 circle>快捷<br />导航</c-box-center>
    </c-main>
